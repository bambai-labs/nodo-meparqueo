...
// Parámetros OTAA
uint8_t devEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };  // <-- pon tu clave real aqui (no la publiques)
uint8_t appEui[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };  // <-- pon tu clave real aqui (no la publiques)
uint8_t appKey[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };  // <-- pon tu clave real aqui (no la publiques)

// Parámetros ABP (no se utilizan en OTAA, se definen para referencia)
uint8_t nwkSKey[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };  // <-- pon tu clave real aqui (no la publiques)
uint8_t appSKey[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };  // <-- pon tu clave real aqui (no la publiques)
uint32_t devAddr = (uint32_t)0x00000000;  // <-- tu devAddr real
